...
const Terms: React.FC<TermsProps> = ({ onBack, language }) => {
  return (
    <div className="bg-background-light dark:bg-background-dark animate-in fade-in duration-700 min-h-screen">
      ...
      <div className="py-20 px-6 border-b border-gray-100 dark:border-white/5 text-center">
        <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white mb-6 font-display tracking-tight">Terms of Service</h1>
      ...
      <div className="max-w-4xl mx-auto py-24 px-6 md:px-12 space-y-16">
        <section>
          ...
          <div className="text-slate-600 dark:text-text-muted leading-relaxed space-y-4 text-sm font-medium">
            <p>
              By accessing and using Transfer Line ("the Service"), you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must refrain from using our chauffeur and intercity travel services.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="text-slate-600 dark:text-text-muted leading-relaxed space-y-4 text-sm font-medium">
            <p>
              Transfer Line provides executive private transportation services across the United Kingdom. We reserve the right to modify or discontinue any aspect of the service at any time without prior notice. 
            </p>
        ...
        <section>
          ...
          <div className="text-slate-600 dark:text-text-muted leading-relaxed space-y-4 text-sm font-medium">
            <p>
              We understand that schedules change. To maintain our elite chauffeur availability, the following cancellation terms apply:
            </p>
            <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          ...
          <div className="text-slate-600 dark:text-text-muted leading-relaxed space-y-4 text-sm font-medium">
            <p>
              Transfer Line holds comprehensive commercial insurance for all vehicles and passengers. However, we are not liable for delays caused by circumstances beyond our control (force majeure), including extreme weather, road closures, or industrial action.
            </p>
          </div>
        </section>

        <div className="pt-12 border-t border-gray-100 dark:border-white/5 flex flex-col items-center">
          <p className="text-sm text-text-muted mb-8 italic">If you have questions regarding these terms, please contact our concierge at support@transferline.uk</p>
          <button 
            onClick={onBack}
