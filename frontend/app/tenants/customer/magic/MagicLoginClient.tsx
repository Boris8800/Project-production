...
export default function CustomerMagicLoginClient() {
              ...
              <div className="flex items-start justify-between gap-6">
                <div>
                  ...
                  <p className="mt-3 text-sm text-slate-600 dark:text-slate-200 font-medium leading-relaxed">
                    If you were redirected here automatically, please keep this page open for a moment.
                  </p>
                </div>

                <div className="hidden sm:flex flex-col gap-3">
                  <button
                    onClick={() => router.push('/tenants/customer')}
