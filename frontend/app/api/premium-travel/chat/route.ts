...
export async function POST(req: Request) {
  ...
  const systemInstruction =
    "You are a professional, helpful, and sophisticated UK travel concierge for TransferLane. Use British English. Prices in GBP (£). Always maintain an elite and refined tone.";
